...
//   // каждая смена профиля загружает его данные
//   // стартовая подгрузка профиля
//   useEffect(() => {
//     async function loadProfile() {
...
//   async function handleChange(e) {
//     const file = e.target.files[0]; // сам файл
//     const path = `${userId}/avatar.png`; // его название для сервера
//     const { error } = await supabase.storage
//       .from("avatars")
//       .upload(path, file, { upsert: true });
//     const { data } = await supabase.storage.from("avatars").getPublicUrl(path);
//     console.log(data);
//     const imgLink = data.publicUrl;
//     setForm((prev) => ({ ...prev, avatar_url: imgLink }));
//   }

//   let imgSrc;
//   if (form.avatar_url === "")
//     imgSrc =
//       "https://avatars.mds.yandex.net/i?id=cf0a04393bac3bbed00ac4db6aeac32a0c8e6ef5-15156312-images-thumbs&n=13";
//   else imgSrc = form.avatar_url;
...
//             />
//             <input type="file" />*/}
//             <img className="gg" src={imgSrc}></img>
//             <div className="meta">
//               <h2 className="name">{form.full_name || "Без имени"}</h2>
//               <div className="username">
//                 {form.username ? `@${form.username}` : "—"}
